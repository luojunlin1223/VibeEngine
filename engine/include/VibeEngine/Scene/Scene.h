...
struct RenderDiagnostics {
    ...
    bool HPWaterRefractionBoundaryFadeEnabled = false;
    bool HPWaterRefractionBufferFormatParityEnabled = false;
    ...
    uint32_t HPWaterTiledLightListTileSize = 0;
    uint32_t HPWaterTiledLightListGridWidth = 0;
    uint32_t HPWaterTiledLightListGridHeight = 0;
    ...
    bool HPWaterTiledLightListShaderConsumerEnabled = false;
    ...
    bool HPWaterLightPayloadGPUUploadEnabled = false;
    bool HPWaterLightPayloadShaderConsumerEnabled = false;
    uint32_t HPWaterLightPayloadPointCount = 0;
    uint32_t HPWaterLightPayloadSpotCount = 0;
    uint32_t HPWaterLightPayloadAreaCount = 0;
    uint32_t HPWaterLightPayloadGPUBufferBytes = 0;
    ...
    bool HPWaterSSRResolveDiagnosticsValid = false;
    ...
    uint32_t HPWaterSSRResolveDiagnosticsTexture = 0;
    ...
    bool HPWaterVolumeObjectMotionIDSelectionEnabled = false;
    uint32_t HPWaterVolumeObjectMotionDiagnosticsTexture = 0;
    ...
    float HPWaterVolumeExponentialStepFactor = 0.0f;
    bool HPWaterVolumeReferenceRayMarchParityEnabled = false;
    ...
    bool HPWaterVolumeUpsampleWaterMarkerAwareEnabled = false;
    ...
    uint32_t HPWaterCausticComputeTextureR = 0;
    uint32_t HPWaterCausticComputeTextureG = 0;
    uint32_t HPWaterCausticComputeTextureB = 0;
    ...
    float HPWaterCausticAtomicScale = 0.0f;
    bool HPWaterCausticAtomicScaleParityEnabled = false;
    ...
    bool HPWaterCausticNDCProjectionEnabled = false;
    ...
    bool HPWaterFluidMultiSourceEnabled = false;
    ...
    bool HPWaterFluidWorldNormalBlendParityEnabled = false;

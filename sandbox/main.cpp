...
private:
    ...
    struct MaskedTextureProbeSummary {
        ...
        float MaskedLuminanceStdDev = 0.0f;
        ...
        std::array<float, 3> MaskedRGBStdDev = { 0.0f, 0.0f, 0.0f };
        ...
        float MaskedAverageChroma = 0.0f;
    ...
    MaskedTextureProbeSummary ProbeMaskedTextureVisibility(uint32_t outputTexture,
        ...
        std::array<double, 3> rgbSquareSum = { 0.0, 0.0, 0.0 };
        double luminanceSum = 0.0;
        ...
        for (size_t pixel = 0; pixel < pixelCount; ++pixel) {
            ...
            rgbSum[1] += g;
            rgbSum[2] += b;
            rgbSquareSum[0] += static_cast<double>(rf) * rf;
            rgbSquareSum[1] += static_cast<double>(gf) * gf;
            rgbSquareSum[2] += static_cast<double>(bf) * bf;
            luminanceSum += luminance;
            luminanceSquareSum += static_cast<double>(luminance) * luminance;
            chromaSum += std::max({ rf, gf, bf }) - std::min({ rf, gf, bf });
            if (r > 2 || g > 2 || b > 2)
                maskedNonBlack++;
            maskedPixels++;
        }
        ...
        const double luminanceVariance =
            std::max(0.0, luminanceSquareSum / maskedPixels -
                static_cast<double>(summary.MaskedAverageLuminance) * summary.MaskedAverageLuminance);
        summary.MaskedLuminanceStdDev = static_cast<float>(std::sqrt(luminanceVariance));
        ...
        for (size_t channel = 0; channel < 3; ++channel) {
            const double channelVariance =
                std::max(0.0, rgbSquareSum[channel] / maskedPixels -
                    static_cast<double>(summary.MaskedAverageRGB[channel]) * summary.MaskedAverageRGB[channel]);
            summary.MaskedRGBStdDev[channel] = static_cast<float>(std::sqrt(channelVariance));
        }
        ...
        summary.MaskedAverageChroma = static_cast<float>(chromaSum / maskedPixels);
        ...
        summary.MaskedVisualComplexity =
            summary.MaskedLuminanceStdDev +
            0.5f * summary.MaskedAverageChroma +
            2.0f * summary.MaskedAverageLuminanceGradient +
            0.25f * summary.MaskedColorRange;
        return summary;
    }
    ...
    bool HasHPWaterSSRTextureEvidence() {
        ...
        const uint32_t resolveDiagnosticsTexture = dr.GetHPWaterSSRResolveDiagnosticsTexture();
        if (diagnosticsTexture == 0 || lightingTexture == 0 || motionVectorTexture == 0 ||
            resolveDiagnosticsTexture == 0)
            return false;
        ...
        const TextureProbeSummary resolveDiagnosticsProbe =
            ProbeTexture(resolveDiagnosticsTexture, dr.GetWidth(), dr.GetHeight());
    ...
    bool HasHPWaterAreaLightTextureEvidence() {
        ...
        if (d.HPWaterAreaLightDiagnosticsTexture == 0 ||
    ...
    bool HasHPWaterFinalCompositeEvidence() {
        ...
        return maskProbe.Valid &&
            ...
            maskedOutputProbe.MaskedLuminanceStdDev > 0.0025f &&
            maskedOutputProbe.MaskedVisualComplexity > 0.01f &&
    ...
    void WriteRenderDiagnosticsFile() {
        ...
        out << "HPWaterMipLevelScatterDensityEnabled: " << d.HPWaterMipLevelScatterDensityEnabled << "\n";
        ...
        out << "HPWaterVolumeAreaLightDiagnosticsTexture: "
        ...
        out << "HPWaterSSRResolveDiagnosticsValid: "
            << d.HPWaterSSRResolveDiagnosticsValid << "\n";
        ...
        out << "HPWaterSSRResolveDiagnosticsTexture: "
            << d.HPWaterSSRResolveDiagnosticsTexture << "\n";
        ...
        auto writeMaskedProbe = [&](const char* name, const MaskedTextureProbeSummary& p) {
            ...
            out << "MaskedLuminanceStdDev: " << std::fixed << std::setprecision(6) << p.MaskedLuminanceStdDev << "\n";
            ...
            out << "MaskedAverageChroma: " << std::fixed << std::setprecision(6) << p.MaskedAverageChroma << "\n";
            ...
            out << "MaskedVisualComplexity: "
                << std::fixed << std::setprecision(6) << p.MaskedVisualComplexity << "\n";
        };
        ...
        if (dr.IsInitialized() && dr.GetHPWaterSSRResolveDiagnosticsTexture() != 0) {
            TextureProbeSummary ssrResolveDiagnosticsProbe =
                ProbeTexture(dr.GetHPWaterSSRResolveDiagnosticsTexture(), dr.GetWidth(), dr.GetHeight());
            writeProbe("HPWaterSSRResolveDiagnostics", ssrResolveDiagnosticsProbe);
            out << "HPWaterSSRResolveDiagnosticsReadbackEnabled: "
                << ssrResolveDiagnosticsProbe.Valid << "\n";
            out << "HPWaterSSRResolveDiagnosticsAverageRoughnessConeLOD: "
                << std::fixed << std::setprecision(4)
                << ssrResolveDiagnosticsProbe.AverageRGBA[0] << "\n";
            out << "HPWaterSSRResolveDiagnosticsAverageHistoryWeight: "
                << std::fixed << std::setprecision(4)
                << ssrResolveDiagnosticsProbe.AverageRGBA[1] << "\n";
            out << "HPWaterSSRResolveDiagnosticsAverageDisocclusionAccepted: "
                << std::fixed << std::setprecision(4)
                << ssrResolveDiagnosticsProbe.AverageRGBA[2] << "\n";
            out << "HPWaterSSRResolveDiagnosticsAverageMotionVectorMode: "
                << std::fixed << std::setprecision(4)
                << ssrResolveDiagnosticsProbe.AverageRGBA[3] << "\n";
            out << "HPWaterSSRResolveDiagnosticsAnyRoughnessCone: "
                << (ssrResolveDiagnosticsProbe.MaxRGBA[0] > 0.0f ? 1 : 0) << "\n";
            out << "HPWaterSSRResolveDiagnosticsAnyTemporalHistory: "
                << (ssrResolveDiagnosticsProbe.MaxRGBA[1] > 0.0f ? 1 : 0) << "\n";
            out << "HPWaterSSRResolveDiagnosticsAnyDisocclusionAccepted: "
                << (ssrResolveDiagnosticsProbe.MaxRGBA[2] > 0.0f ? 1 : 0) << "\n";
            out << "HPWaterSSRResolveDiagnosticsAnyMotionVectorMode: "
                << (ssrResolveDiagnosticsProbe.MaxRGBA[3] > 0.0f ? 1 : 0) << "\n";
            SaveTextureBMP(dr.GetHPWaterSSRResolveDiagnosticsTexture(), dr.GetWidth(), dr.GetHeight(),
        ...
        if (dr.IsInitialized() && d.HPWaterVolumeAreaLightDiagnosticsTexture != 0 &&
            ...
            TextureProbeSummary volumeAreaLightDiagnosticsProbe =
                ProbeTexture(d.HPWaterVolumeAreaLightDiagnosticsTexture,
                    d.HPWaterVolumeWidth,
                    d.HPWaterVolumeHeight);
            writeProbe("HPWaterVolumeAreaLightDiagnostics", volumeAreaLightDiagnosticsProbe);
            out << "HPWaterVolumeAreaLightDiagnosticsReadbackEnabled: "
                << volumeAreaLightDiagnosticsProbe.Valid << "\n";
            out << "HPWaterVolumeAreaLightDiagnosticsAverageLuminance: "
                << std::fixed << std::setprecision(4)
                << volumeAreaLightDiagnosticsProbe.AverageLuminance << "\n";
            out << "HPWaterVolumeAreaLightDiagnosticsNonBlackRatio: "
                << std::fixed << std::setprecision(4)
                << volumeAreaLightDiagnosticsProbe.NonBlackRatio << "\n";
            out << "HPWaterVolumeAreaLightDiagnosticsAnyContribution: "
                << (volumeAreaLightDiagnosticsProbe.MaxRGBA[0] > 0.0f ||
                    volumeAreaLightDiagnosticsProbe.MaxRGBA[1] > 0.0f ||
                    volumeAreaLightDiagnosticsProbe.MaxRGBA[2] > 0.0f ? 1 : 0) << "\n";
            SaveTextureBMP(d.HPWaterVolumeAreaLightDiagnosticsTexture,
                d.HPWaterVolumeWidth,
                d.HPWaterVolumeHeight,
                std::filesystem::path(VE_PROJECT_ROOT) /
                    "render_diagnostics_hpwater_volume_area_light_diagnostics.bmp");
        }
        ...
        if (m_RenderDiagnosticsOnce) {
            ...
            const bool ssrReady =
                ...
                (d.HPWaterSSRReflectionEnabled &&
                 ...
                 d.HPWaterSSRResolveDiagnosticsTexture != 0 &&
            ...
            const bool lightLoopReady =
                ...
                (d.HPWaterLightLoopInputsValid &&
                 ...
                 d.HPWaterMipLevelScatterDensityEnabled &&
                 d.HPWaterForwardScatterMipCount > 1 &&
                 d.HPWaterForwardScatterDiagnosticsTexture != 0 &&
    ...
    void DrawRenderDebuggerPanel() {
        ...
        ImGui::Text("HPWater light loop: valid=%d surfaceShadow=%d cascadeDither=%d sharedNoise=%d mipScatter=%d punctual=%d areaApprox=%d areaRect=%d areaLTC=%d/%u/%u ltcHDRP=%d ltcSample=%d ltcHDRPUV=%d ltcCosTheta=%d ltcMatrix=%d ltcPoly=%d ltcHorizonClip=%d point=%u/%u spot=%u/%u area=%u/%u cap=%u/%u/%u layerFilter=%d areaLayerFilter=%d influenceSort=%d layerSkip=%u areaLayerSkip=%u capSkip=%u areaCapSkip=%u volumePunctual=%d volumeArea=%d volumeAreaRect=%d volumeAreaPoly=%d volumeHorizonClip=%d vPoint=%u vSpot=%u vArea=%u indirectScatter=%d bsdfWeights=%d punctualBody=%d specOcc=%d skyRefl=%.3f indirect=%.3f dir=%.3f",
            ...
            d.HPWaterMipLevelScatterDensityEnabled ? 1 : 0,
        ...
        ImGui::Text("HPWater SSR hierarchy: enabled=%d blend=%d ssrBuf=%d/%d pre=%d refine=%d cone=%d temporal=%d history=%d mv=%d mvHistory=%d reproj=%d disocc=%d resolveDiag=%d (%u) consume=%d (%u) diag=%d (%u) steps=%u step=%.3f thickness=%.3f maxDist=%.1f",
            ...
            d.HPWaterSSRResolveDiagnosticsValid ? 1 : 0,
            d.HPWaterSSRResolveDiagnosticsTexture,
        ...
        ImGui::Text("HPWater forward scatter mips: enabled=%d scatterDensity=%d count=%u",

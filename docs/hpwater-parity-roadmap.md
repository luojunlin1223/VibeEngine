...
- Caustic accumulation reports `HPWaterCausticTransmittanceMaskEnabled=1` and exports serialized `HPWaterCausticTransmittanceStrength`, `HPWaterCausticLeakReduction`, and `HPWaterCausticScatterBoost` values while keeping `HPWaterCausticValid=1`.
